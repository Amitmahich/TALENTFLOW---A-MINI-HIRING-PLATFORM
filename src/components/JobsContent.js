...
//   const handleEdit = (id) => alert(`✏️ Edit job ${id}`);
...
//                 <input
//                   type="text"
//                   placeholder="Required Skills (must-have) & press Enter"
//                   value={reqSkillInput}
...
//                 <input
//                   type="text"
//                   placeholder="Preferred Skills (nice-to-have) & press Enter"
...
//               <input
//                 type="text"
//                 placeholder="Location (Onsite / Remote / Hybrid)"
//                 value={location}
...
//               <input
//                 type="text"
//                 placeholder="Work Type (Full-time / Part-time / Internship)"
//                 value={workType}
...
// export default function JobsContent({ openJobDetail }) {
//   const [jobs, setJobs] = useState([]);
//   const [loading, setLoading] = useState(true);
//   const [showForm, setShowForm] = useState(false);
//   const [error, setError] = useState("");
...
//     setJobs([...jobs, { ...newJob, candidates: 0 }]);
//     resetForm();
//     setShowForm(false);
//   };
...
//               key={job.id}
//               className="job-card"
//               onClick={() => openJobDetail(job.slug)}
//               style={{ cursor: "pointer" }}
//             >
//               <div className="job-header">
//                 <h3>{job.title}</h3>
